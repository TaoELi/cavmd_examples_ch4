...
INPUTFOLDER=$HOMEFOLDER/eq_cavity_loss_running_input_"$E0"
...
# run 1 cavity loss NVE simulation
NVEXYZ=$HOMEFOLDER/cavity_loss_eqxyznve
mkdir $NVEXYZ
OUTFOLDER=$HOMEFOLDER/cavity_loss_eqout
mkdir $OUTFOLDER

NVEFOLDER=$HOMEFOLDER/cavity_loss_eqnve_"$traj"
