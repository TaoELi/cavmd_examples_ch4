...
INPUTFOLDER=$HOMEFOLDER/eq_cavity_loss_running_input_"$FREQIDX"
...
NVEXYZ=$HOMEFOLDER/cavity_loss_eqxyznve_"$FREQIDX"
mkdir $NVEXYZ
OUTFOLDER=$HOMEFOLDER/cavity_loss_eqout_"$FREQIDX"
mkdir $OUTFOLDER

NVEFOLDER=$HOMEFOLDER/cavity_loss_eqnve_"$FREQIDX"_"$traj"
